...
const GENERATION_QUOTES = [
  ...
  'Die KI strukturiert gerade dein Transkript – gründlicher als eine Katze beim Putzen 🐱',
  ...
  'Formulierungen werden poliert – präziser als ein Ultraschallbild 🔬',
  ...
  'Strukturierung läuft... gründlicher als die Anamnese eines besorgten Hundebesitzers 🐾',
  ...
  const buildSmartPrompt = (combinedInput: string): string => {
    ...
    if (type === 'meeting') {
      return [
        ...
        'STRUKTUR:',
        '# Zusammenfassung',
        'Kurzer Überblick (3-5 Sätze): Wer hat mit wem gesprochen, wann, Hauptthemen.',
        '',
        '# Besprochene Themen',
        'Für jedes Thema eine eigene Unterüberschrift (##) mit den wichtigsten Punkten als Bulletpoints.',
        ...
        '- Konkrete Zahlen, Namen, Termine immer übernehmen.',
    ...
    if (type === 'clinical') {
      return [
        ...
        '- Bulletpoints verwenden (ausser Patientenbrief)',
        ...
        '',
        'WICHTIG ZUSAETZLICH:',
        '- Wenn eine Bildanalyse oder zusaetzliche Befunde vorhanden sind, integriere diese aktiv in die medizinische Bewertung',
        '- Vermeide Aussagen wie "Roentgen steht aus", wenn ein Befund vorliegt',
        '- Verknuepfe klinische Untersuchung und Bildbefund logisch',
        '',
        'Klinische Untersuchung:',
